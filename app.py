...
class AgentK8s:
    ...
    def initialize_bedrock(self, region='us-east-1'):
        try:
            # Use default credentials from AWS credentials file or environment variables
...
def main():
    ...
    with st.sidebar:
        ...
        with st.form("credentials_form"):
            ...
            if submit_button:
                if ares_api_key and openai_api_key:
                    if (st.session_state.agent.initialize_bedrock(aws_region) and 
